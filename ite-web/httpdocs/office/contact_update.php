...
if ($_POST['pagecontent_update']) {
	...
	$pagecontent_Update = "UPDATE `pagecontent` SET `pagecontent_review` = '$pagecontent_review' ,`pagecontent_eng_review` = '$pagecontent_eng_review' ,`pagecontent_update` = NOW()  WHERE pagecontent_name = 'contact'";
						...
						<form method="post" action="">
							<div class="panel panel-default">
								<div class="panel-heading">
									กรอกรายละเอียด "ติดต่อเรา"  ที่ต้องการแก้ไข
								</div>
