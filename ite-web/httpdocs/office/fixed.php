...
if ($_POST['Updatefixed']) {
	...
	$fixed_website = function_teeth($_POST['fixed_website']);
								...
								<form class="form-horizontal" method="post" >
									<div class="form-group">
										...
										<div class="col-sm-4 control-label text-left">
											<? 
											if (isset($fixed[fixed_eng_company])&&trim($fixed[fixed_eng_company])!='') {
												echo " (ภาษาอังกฤษ) "; echo $fixed[fixed_eng_company]; 
											}
											?>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-6 control-label text-left">
											<? 
											if (isset($fixed[fixed_eng_topic])&&trim($fixed[fixed_eng_topic])!='') {
												echo " (ภาษาอังกฤษ) "; echo $fixed[fixed_eng_topic]; 
											}
											?>
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-sm-3" for="email">ลิ้งเว็บไซต์</label>
										<div class="col-sm-6 control-label text-left">
											<? echo $fixed[fixed_website]; ?>
										</div>
									</div>
									<div class="form-group">
				...
				<form action="" method="post" enctype="multipart/form-data">
					...
					<div class="modal-body">
						<div class="form-group">
							...
							<input   name="fixed_eng_company" value="<? echo $fixed[fixed_eng_company]; ?>" type="text" class="form-control" placeholder="ภาษาอังกฤษ" >
						</div>
						<div class="form-group">
							...
							<input   name="fixed_eng_topic" value="<? echo $fixed[fixed_eng_topic]; ?>" type="text" class="form-control" placeholder="ภาษาอังกฤษ" >
						</div>

						<div class="form-group">
							<label class="control-label" for="email"> ลิ้งเว็บไซต์ </label>
							<input  name="fixed_website" value="<? echo $fixed[fixed_website]; ?>" type="text"  class="form-control" placeholder="www.name.com" >
						</div>
						<div class="form-group">
