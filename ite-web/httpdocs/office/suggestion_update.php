	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-md-10">
				<div class="row">
					<div class="col-md-12">
						<h3>  แก้ไขหัวข้อแนะนำเว็บ   : <span class="text-primary bold"> <?php echo $suggestion[suggestion_name]; ?> </span>  </h3>
						<hr>
					</div>
				</div>
				<div class="row">
						...
						<form class="form-horizontal" method="post" enctype="multipart/form-data">
							<div class="panel panel-default">
								<div class="panel-heading">
									กรอกรายละเอียด " หัวข้อแนะนำเว็บ " ที่ต้องการแก้ไข
								</div>
								<div class="panel-body">
									<div class="form-group"> 
										<label class="control-label col-md-3" > รูปหัวข้อแนะนำเว็บ   </label>
										<div class="col-md-6">
