...
if ($_POST['pagecontent_update']) {
	...
	$pagecontent_Update = "UPDATE `pagecontent` SET `pagecontent_review` = '$pagecontent_review' ,`pagecontent_update` = NOW()  WHERE pagecontent_name = 'tagfooter'";
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-md-10">
				<div class="row">
					<div class="col-md-12">
						<h3>  แก้ไข   ข้อความล่างสุด  </h3>
						<hr>
					</div>
				</div>
				<div class="row">
					<div class="col-md-12 br-margin2">
						<a href="tagfooter.php" class="btn btn-primary"><span class="glyphicon glyphicon-step-backward"></span> กลับ </a>
					</div>
					<div class="col-md-12">
						<form method="post" action="">
							<div class="panel panel-default">
								<div class="panel-heading">
									กรอกรายละเอียด "  ข้อความล่างสุด " ที่ต้องการแก้ไข
								</div>
