...
if (isset($_GET[keyword])&&$_GET[keyword]!='') {
	...
	$keyword= str_replace("\"","&quot;",$keyword);
	if ($Q==1) {
		$Row .= " ( web_content_name LIKE '%$keyword%'  OR  web_content_detail LIKE '%$keyword%'  OR web_content_review LIKE '%$keyword%'  OR web_content_page LIKE '%$keyword%' )";
		$Q++;
	}
	else{
		$Row .= " AND  ( web_content_name LIKE '%$keyword%'  OR  web_content_detail LIKE '%$keyword%'  OR web_content_review LIKE '%$keyword%'  OR web_content_page LIKE '%$keyword%' ) ";
		$Q++;
	}
}
...
<body>
				...
				<div class="row">
					<div class="col-md-6">
						<form class="form-inline" method="get">
							<div class="form-group" style="margin-bottom: 15px;">
								<a href="web_content_add.php" class="btn btn-success">
					...
					<div class="col-md-6 text-right">
						<form class="form-inline" method="get">
							...
							<div class="form-group" style="margin-bottom: 15px;">
								<a href="web_content.php" class="btn btn-default">
							...
							<div class="panel-heading">
								<div class="row">
									<div class="col-md-6">
										...
										?>
										<?
										if ($Num_Rows=='0') { echo "( ไม่มีหน้าเพจนี้ )"; }
										else{ 
											?>
									...
									<div class="col-md-6 text-right" style="margin: -5px;">
										...
										if ($Q!=1) {
											...
											<a class="btn btn-default" href="web_content.php">
												หน้าเพจ
											</a>
											<?
										}
											...
											while ($web_content 	= mysqli_fetch_array($web_content_QR)) {
												...
												<tr id="<?php echo $web_content['web_content_id'] ?>">
													...
													<td style="width: 300px;">
														<a href="web_content_one.php?web_content_id=<?php echo $web_content[web_content_id]; ?>" class="btn btn-sm btn-primary">
															<span class="glyphicon glyphicon-zoom-in"></span>
															รายละเอียด  
														</a>
														<a href="web_content_update.php?web_content_id=<?php echo $web_content[web_content_id]; ?>" class="btn btn-sm btn-info">
															<span class="glyphicon glyphicon-edit"></span>
															แก้ไข
														</a>
														<a href="web_content_del.php?web_content_id=<?php echo $web_content[web_content_id]; ?>" onclick="return confirm('  ยืนยันการลบหน้าเพจ  ? ')"  class="btn btn-sm btn-danger">
	...
	$web_content_sort_i=1;
	foreach($position as $k=>$v){
		$sql = "Update web_content SET web_content_sort=".$web_content_sort_i." WHERE web_content_id =".$v;
		$mysqli->query($sql);
