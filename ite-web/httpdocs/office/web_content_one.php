...
if ($_GET[web_content_photo]=='delete') {

	@unlink("../Files/web_content_photo/".$web_content['web_content_photo']);
	$web_content_photo_Update = "UPDATE `web_content` SET `web_content_photo` = '' WHERE web_content_id = '$web_content_id' ";
	$web_content_photo_Reult = mysqli_query($con,$web_content_photo_Update);

	echo"<script>alert('แก้ไขเรียบร้อยแล้ว'); window.location='web_content_one.php?update';</script>";

}

if ($_GET[web_content_cover]=='delete') {

	@unlink("../Files/web_content_cover/".$web_content['web_content_cover']);
	$web_content_cover_Update = "UPDATE `web_content` SET `web_content_cover` = '' WHERE web_content_id = '$web_content_id' ";
...
if ($_POST['web_content_pictureAdd']) {
	if(isset($_FILES['web_content_picture_photo']['name'])&&$_FILES['web_content_picture_photo']['name']!=''){
		...
		for ($i=0; $i < $Count; $i++) { 
			$web_content_picture_photo = rand().$_FILES["web_content_picture_photo"]["name"][$i];
			if(move_uploaded_file($_FILES["web_content_picture_photo"]["tmp_name"][$i],"../Files/web_content_picture_photo/".$web_content_picture_photo)){
				$web_content_picture_Add = "INSERT INTO `web_content_picture` (`web_content_id`,`web_content_picture_photo`) VALUES ('$web_content_id','$web_content_picture_photo')";
...
if ($_GET['web_content_pictureDel']) {
	$web_content_picture_id =   $_GET[web_content_picture_id];
	$web_content_picture_SL = " SELECT * FROM web_content_picture WHERE web_content_picture_id = '$web_content_picture_id'";
	$web_content_picture_QR = mysqli_query($con,$web_content_picture_SL);
	$web_content_picture 	= mysqli_fetch_array($web_content_picture_QR);
	@unlink("../Files/web_content_picture_photo/".$web_content_picture['web_content_picture_photo']);
	$web_content_picture_Del ="DELETE FROM `web_content_picture` WHERE web_content_picture_id = '$web_content_picture_id' ";
	$web_content_picture_Qurey  = mysqli_query($con,$web_content_picture_Del);
	if($web_content_picture_Qurey) {
		echo"<script>  window.location='web_content_one.php?DELETE'; </script>";
	}
	else{
...
if ($_POST['web_content_cover']) {
	if($_FILES['web_content_cover']['name']!=''){
		...
		$web_content_cover_Reult = mysqli_query($con,$web_content_cover_Update);
		$table =  'web_content';
		min_resize($web_content_cover,$table);
		if (!$web_content_cover_Reult) {
			echo"<script>alert('เกิดข้อผิดพลาด'); window.history.back(); </script>";
		}
		if ($web_content_cover_Reult) {
			echo"<script>   window.location='web_content_one.php?UPDATE'; </script>";
...
if ($_POST['add_gallery']) {
	...
	if (  trim($gallery_photo)==''   &&  trim($gallery_video)==''   && trim($gallery_review)==''  &&  trim($gallery_youtube)==''  &&  trim($gallery_facebook)==''   &&  trim($gallery_link)==''   &&  trim($gallery_download)==''  ) {
		...
		VALUES ('$gallery_link','$gallery_review','$gallery_youtube','$gallery_facebook','web_content_id$web_content_id')";
		...
		echo"<script>  window.location='web_content_one.php#gallery".$_SESSION[gallery_id]."'; </script>";
	}
}
...
if ($_POST['update_gallery']) {
	...
	if ($gallery_Reult) {
		...
		echo"<script>  window.location='web_content_one.php?UPDATE#gallery".$gallery_id."'; </script>";
	}
}
if ($_GET['gallery_del']) {
...
<body>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-md-10">
				<div class="row">
					<div class="col-md-12">
						<h3>       หน้าเพจ      : <span class="text-primary bold"> <?php echo $web_content[web_content_name]; ?> </span>  </h3>
						<hr>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-12 br-margin2">
						<a href="web_content.php?page=<? echo $page; ?>" class="btn btn-primary"><span class="glyphicon glyphicon-step-backward"></span> กลับ </a>
						<a href="web_content_update.php?web_content_id=<?php echo $web_content[web_content_id]; ?>" class="btn btn-info"><span class="glyphicon glyphicon-wrench"></span> แก้ไข</a>
						<a href="web_content_del.php?web_content_id=<?php echo $web_content[web_content_id]; ?>" onclick="return confirm(' ยืนยันการลบหน้าเพจ ? ')"  class="btn btn-danger">
					...
					<div class="col-md-8">
						<div class="panel panel-default">
							<div class="panel-heading">
								รายละเอียดหน้าเพจ     :  <span class="text-primary bold"> <?php echo $web_content[web_content_name]; ?> </span>
							</div>
								...
								<div class="row br-margin2">
									<div class="col-md-12">
										<form class="form-horizontal">
											...
											<div class="form-group">
												<label class="control-label col-md-3" > ชื่อหน้าเพจ     </label>
												<label class="control-label col-md-9 text-left">
											...
											<div class="form-group">
												...
												<label class="control-label col-md-9 text-left">
													<? 
													if (isset($web_content[web_content_detail])&&trim($web_content[web_content_detail])!='') {
						...
						<div class="panel panel-default">
							...
							<div class="panel-body Review">
								<?php echo $web_content[web_content_review]; ?>
							</div>
						</div>		
						...
						<div class="panel panel-default" id="gallery">
							...
							<div class="panel-body">
								<?
								$gallery_SL = " SELECT * FROM gallery WHERE gallery_code = 'web_content_id$web_content[web_content_id]' ORDER BY gallery_sort IS NULL ASC, gallery_id ASC";
								$gallery_QR 	= mysqli_query($con,$gallery_SL);
													...
													<td id="gallery<?php echo $gallery[gallery_id]; ?>">	
														...
														if (isset($gallery[gallery_photo])&&trim($gallery[gallery_photo])!='') {
															...
															<div class="caption" style="margin: 10px;">
																...
																<a href="web_content_one.php?gallery_id=<?php echo $gallery[gallery_id]; ?>&gallery_del=x" onclick="return confirm(' ยืนยันการลบข้อมูล  ? ')"  class="btn btn-sm btn-danger"><span class="glyphicon glyphicon-trash"></span> ลบ </a>
															</div>
							...
							<div class="panel-heading"> 
								<div class="row">
									...
									<div class="col-md-8 text-right" style="margin: -5px;">
										<button type="button" class="btn btn-sm btn-info " data-toggle="modal" data-target="#web_contentUpdate"> 
											<span class="glyphicon glyphicon-picture"></span>
											แก้ไขรูปเนื้อหา
										</button>
										<a onclick="return confirm(' ยืนยันการลบ ? ')"  href="web_content_one.php?web_content_photo=delete"  type="button" class="btn btn-sm btn-danger" > 
											ลบ
										</a>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-md-12 br-margin2">
										...
										if (!empty($web_content['web_content_photo'])) {
											?>
											<img class="full" style="cursor: zoom-in;" id="myImgmain<?php echo $web_content[web_content_id]; ?>" src="../Files/web_content_photo/<?php echo $web_content[web_content_photo]; ?>"  />
											...
											<script>
												...
												var img = document.getElementById("myImgmain<?php echo $web_content[web_content_id]; ?>");
						...
						<div class="panel panel-default">
							<div class="panel-heading"> 
								<div class="row">
									...
									<div class="col-md-8 text-right" style="margin: -5px;">
										<button type="button" class="btn btn-sm btn-info " data-toggle="modal" data-target="#web_content_cover"> 
											<span class="glyphicon glyphicon-picture"></span>
											แก้ไขรูป cover
										</button>
										<a onclick="return confirm(' ยืนยันการลบ ? ')"  href="web_content_one.php?web_content_cover=delete"  type="button" class="btn btn-sm btn-danger" > 
											ลบ
										</a>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-md-12 br-margin2">
										...
										if (isset($web_content[web_content_cover]) && trim($web_content[web_content_cover])!='') {
											?>
											<img class="full" style="cursor: zoom-in;" id="myImgmain<?php echo $web_content[web_content_cover]; ?>" src="../Files/web_content_cover/<?php echo $web_content[web_content_cover]; ?>"  />
											<div id="myModal" class="w3-modal">
												<span class="zoom-close w3-close">&times;</span>
												<img class="w3-modal-content w3-close" id="img01">
											</div>
											<script>
												var w3modal = document.getElementById("myModal");
												var img = document.getElementById("myImgmain<?php echo $web_content[web_content_cover]; ?>");
												var modalImg = document.getElementById("img01");
												img.onclick = function(){
													w3modal.style.display = "block";
													modalImg.src = this.src;
						...
						<div class="panel panel-default">
							<div class="panel-heading"> 
								<div class="row">
									...
									<div class="col-md-8 text-right" style="margin: -5px;">
										<button type="button" class="btn btn-sm btn-success " data-toggle="modal" data-target="#web_content_pictureAdd"> 
											<span class="glyphicon glyphicon-picture"></span>
											เพิ่มรูป 
										</button>
									</div>
							...
							<div class="panel-body">
								<div class="row">
									<?
									$web_content_picture_SL 		= " SELECT * FROM web_content_picture WHERE web_content_id = '$web_content[web_content_id]'";
									$web_content_picture_QR 		= mysqli_query($con,$web_content_picture_SL);
									...
									while ($web_content_picture 	= mysqli_fetch_array($web_content_picture_QR)) {
										...
										<div class="col-md-6">
											<div class="thumbnail">
												<div class="img80">
													<img style="cursor: zoom-in;" id="myImg<?php echo $web_content_picture[web_content_picture_id]; ?>" src="../Files/web_content_picture_photo/<?php echo $web_content_picture[web_content_picture_photo]; ?>"  />
													<div id="myModal" class="w3-modal">
														<span class="zoom-close w3-close">&times;</span>
														<img class="w3-modal-content w3-close" id="img01">
													</div>
												...
												<div class="caption">
													<a href="web_content_one.php?web_content_picture_id=<?php echo $web_content_picture[web_content_picture_id]; ?>&web_content_pictureDel=x" onclick="return confirm('ยืนยันการลบหน้าเพจ  ? ')" ><span class="glyphicon glyphicon-remove-sign"></span> ลบรูปนี้</a>
												</div>
											</div>
										</div>
										<?
	...
	<!-- container -->
	<div id="web_content_pictureAdd" class="modal fade" role="dialog">
		<div class="modal-dialog">
			<div class="modal-content">
				<form class="form" enctype="multipart/form-data" method="post">
					...
					<div class="modal-body">
						<div class="form-group">
							<label for="recipient-name" class="control-label">เลือกรูปภาพ <span class="text-muted normal">เป็นรูปภาพที่จะแสดงต่อจาก รูปหลักของ     หน้าเพจ    </span></label>
							<input type="file" required class="form-control" multiple="multiple" name="web_content_picture_photo[]">
						</div>
					</div>
					<div class="modal-footer">
						<button type="submit"  class="btn btn-success">
						...
						<input type="hidden" name="web_content_pictureAdd" value="x">
						<button type="button" class="btn btn-default" data-dismiss="modal">ยกเลิก</button>
					</div>
				</form>
			</div>
	...
	<div id="web_contentUpdate" class="modal fade" role="dialog">
		<div class="modal-dialog">
			<div class="modal-content">
				<form class="form" enctype="multipart/form-data" method="post">
					<div class="modal-header">
					...
					<div class="modal-body">
						<div class="form-group">
							...
							<input type="file" required class="form-control" multiple="multiple" name="web_content_photo">
						</div>
					</div>
					<div class="modal-footer">
	...
	<div id="web_content_cover" class="modal fade" role="dialog">
		<div class="modal-dialog">
			<div class="modal-content">
				<form class="form" enctype="multipart/form-data" method="post">
					<div class="modal-header">
					...
					<div class="modal-body">
						<div class="form-group">
							<label for="recipient-name" class="control-label">เลือกรูปภาพ <span class="text-muted normal">เป็นรูปภาพที่จะนำมาแทนรูปเดิม</span></label>
							<input type="file" required class="form-control" multiple="multiple" name="web_content_cover">
						</div>
					</div>
					<div class="modal-footer">
						<button  onclick="return confirm('ยืนยันการแก้ไข ? ')" type="submit" class="btn btn-success">
						...
						<input type="hidden" name="web_content_cover" value="x">
						<button type="button" class="btn btn-default" data-dismiss="modal">ยกเลิก</button>
					</div>
				</form>
			</div>
